                        ...
                        <img src={project_img} className="img-fluid w-100 min-h" alt="project2" />
                            <div className="position-abso whitebg-opacity p-lg-5  text-start mt-3">
                                <img src={ncrrLogo} className="img-fluid w-25" alt="Project Logo" />
                                    ...
                                    <a href="project-description-nrc.html" className="btn position-relative px-4 btn-hover logo-clr shadow-none d-none d-lg-inline-block">Read More
                                    ...
                                    <a href="project-description-nrc.html" className="btn position-relative px-4 btn-hover logo-clr shadow-none d-inline-block d-lg-none mt-4">Read More
                                        <span className="forward-icon"><i className="fas fa-long-arrow-alt-right fs-5"></i></span>
                                    </a>
                            </div>
                    </div>
