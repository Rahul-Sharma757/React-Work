...
function About() {
  return (
    <section id="about" class="position-relative">
        <div class="container">
            <div class="row gx-0 h-600">
                <div class="col-lg-6 px-0 py-5 pe-3 text-aligner-lg">
                        <h2 class="display-5 fw-bold logo-clr ">About</h2>
                        <p class="d-none d-lg-block">Kyra Technologies does magic because our developers know 
                        ...
                        <a href="about.html" class="btn position-relative px-4 py-2 btn-hover logo-clr shadow-none d-none d-lg-inline-block">Read more
                            <span class="forward-icon"><i class="fas fa-long-arrow-alt-right fs-5"></i></span>
                        </a>
                </div>
                <div class="col-lg-6 px-0 overflow-auto pos-abso">
                    <img src={AboutImg} class="img-fluid h-600 w-100 obj-fit-cover" alt=" team" />
                    <p class="d-block d-lg-none mt-4">
                    ...
                    <a href="about.html" class="btn position-relative px-4 py-2 btn-hover logo-clr shadow-none d-inline-block d-lg-none mb-5">Read more
                        <span class="forward-icon"><i class="fas fa-long-arrow-alt-right fs-5"></i></span>
                    </a>
                </div>
            </div>
